...
\end{mydef}
\noindent
Any single expert is unlikely to have enough information to consistently report $\logit^{-1}(X_{t,k})$. He may also believe in false information, hide his true belief for ethical bases, or be biased for many other reasons. A large and diverse group of experts, on the other hand, may share a considerable portion of the available information. But if they are not collaborating and sharing information efficiently, their beliefs should be aggregated via a model that can detect potential bias, separate signal from noise, and use the collective opinion to estimate $X_{t,k}$.

%A model should therefore aim to take into account the collective opinion of a group of experts. 
%
%By taking into account the collective opinion the group of experts may be able to 
%
%
%. The collective wisdom of this group is therefore an attractive proxy for the amount of information available at any given time point. 
%
%The experts, however, may not be collaborating and sharing information efficiently with each other. 

%Therefore, if a model is to efficiently use the collective wisdom for estimating $X_{t,k}$, it must be able to discriminate between noise and signal.
